...
if command -v semgrep >/dev/null 2>&1; then
  semgrep scan --config auto --severity ERROR --quiet . 2>&1 | tail -30
else
...
- semgrep: [クリーン / X件 ERROR, Y件 WARNING / スキップ]
