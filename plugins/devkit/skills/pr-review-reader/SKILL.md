...
起動したエージェントとカバーした観点、および**今回チェックされなかった観点**を明示する
（読者が「何が見られて何が見られていないか」を判断できるようにする）。

| 観点群 | 担当 | 起動した？ |
|---|---|---|
| 1-5,19-20,22-24,40 正確性・信頼性・ログ・テスト | quality-reviewer | ✅/❌ |
| 21 要件充足 | requirements-checker | ✅/❌ |
| 6-10 セキュリティ | security-auditor | ✅/❌ |
| 28-32 型・I/F | type-checker | ✅/❌ |
| 11-18,25-27,33-38 設計・運用・パフォーマンス | debt-analyzer | ✅/❌ |
| 39 UX・a11y | ux-reviewer | ✅/❌ |
